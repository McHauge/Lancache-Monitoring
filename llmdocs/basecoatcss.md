...
About
- Basecoat is a Tailwind‑first component library using semantic HTML and small vanilla JS for interactivity. Framework‑agnostic.
...
- Do not simply combine class name variations, use combined classes only
...
Examples of many components: [Kitchensink](https://basecoatui.com/kitchen-sink/)
